...
public partial class SoftUniContext : DbContext
{
    ...
    public virtual DbSet<Employees30000> Employees30000s { get; set; }
    ...
    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        => optionsBuilder.UseSqlServer("Server=.;Integrated Security=true;" +
            "Database=SoftUni;TrustServerCertificate=True;");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.EmployeeId).HasName("PK__Deleted___7AD04F11B4DE03A3");
            ...
            entity.HasOne(d => d.Department).WithMany(p => p.DeletedEmployees)
                .HasForeignKey(d => d.DepartmentId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__Deleted_E__Depar__06CD04F7");
        });
        ...
        {
            entity.ToTable(tb => tb.HasTrigger("tr_InfoFOR_DeletedEmployee"));
        ...
        modelBuilder.Entity<Employees30000>(entity =>
        {
            entity
                .HasNoKey()
                .ToTable("Employees30000");
